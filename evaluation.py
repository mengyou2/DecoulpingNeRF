...
if __name__ == '__main__':
    ...
    lpips_loss = lpips.LPIPS(net='vgg') # best forward scores

    data_dir = '/home/data/DynamicNeRF/results'
    sequences = ['coffee','beef','spinach','steak','searsteak','salmon']

    methods = ['NeRF', 'NeRF_t', 'NR', 'NSFF', 'Gao','Ours']
